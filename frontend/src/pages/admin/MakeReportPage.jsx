...
import {
  TextField,
  validatePlaintext,
} from "../../components/shared/TextField";
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        setSubmissionStatus(
          "Form submitted successfully. The admin team will look over your report shortly.",
        );
      } else {
        ...
        <Col md={6}>
          ...
          >
            ...
            <div className="text-center mt-4">
              {" "}
              {/* Centering the button and status */}
              <Button
                id="report"
              ...
              {submissionStatus && (
                <div className="submission-status mt-2">{submissionStatus}</div>
              )}
            </div>
          </Form>
        </Col>
