    ...
    <>
      <div className=" search mt-4">
        <label>
          <input
            ...
            onChange={(event) =>
              setSearchParams({ ...query, search: event.target.value, page: 1 })
            }
          />
        </label>
      </div>
      <div className="filters">
        ...
        <div className="dropdown-group">
          <p>Breeds:</p>
          <Select
            options={uniqueBreeds.map((breed) => ({
              value: breed,
              label: breed,
            }))}
            isMulti
        ...
        <div className="dropdown-group">
          <p>Shelters:</p>
          <Select
            options={Object.entries(shelterNames).map(([id, name]) => ({
              value: id,
              label: name,
            }))}
            isMulti
            value={query.shelter.map((shelter) => ({
              value: shelter,
              label: shelterNames[shelter],
            }))}
            onChange={(selectedOptions) => {
              setSearchParams({
                ...query,
